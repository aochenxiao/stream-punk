...
__typeFactory.set(E_StreamPunkType.Stone, () => new Stone());
__typeFactory.set(E_StreamPunkType.Move, () => new Move());
...
export class Stone extends Base {
    static readonly typeID = E_StreamPunkType.Stone;
    ...
    to(o: O): this {
        ...
        o.writeI32(this.row);
        o.writeI32(this.col);
        o.writeI32(this.player);
        return this;
    }
}
export class Move extends Base {
    static readonly typeID = E_StreamPunkType.Move;
...
export class GameState extends Base {
    static readonly typeID = E_StreamPunkType.GameState;
    ...
    from(i: I): this {
        super.from(i);
        this.stones = i.readArray(() => new Stone().from(i));
        this.currentPlayer = i.readI32();
        this.winner = i.readI32();
        this.player1Id = i.readI32();
        this.player2Id = i.readI32();
        return this;
    }

    to(o: O): this {
        super.to(o);
        o.writeArray(this.stones, (v) => { writeObj(o, v) });
        o.writeI32(this.currentPlayer);
        o.writeI32(this.winner);
        o.writeI32(this.player1Id);
        o.writeI32(this.player2Id);
        return this;
    }
}
