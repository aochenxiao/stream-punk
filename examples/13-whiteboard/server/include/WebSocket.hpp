...
// StreamPunk 类型别名（WebSocket.hpp 不直接 include StreamPunk.hpp，
// 但由 RoomManager.hpp 在 include 本文件之前已 include，故 sp 命名空间可用）
using sp::u8;
using sp::u16;
using sp::u32;
using sp::u64;
