/**
 * Stream-Punk TypeScript 序列化/反序列化测试套件
 * 运行: node test_stream_punk.js
 */
const { I, O, SpRef, SpArray, SpVariant } = require('../js/stream-punk.js');
...
test('f32 roundtrip', () => {
    ...
    assertTrue(new I(o2.to_array_buffer()).read_f32() === Infinity);
    const o3 = new O(); o3.write_f32(-Infinity);
    assertTrue(new I(o3.to_array_buffer()).read_f32() === -Infinity);
});
